class Security {
    ...
    constructor(){
        ...
        this.access2.position(displayWidth-300,displayHeight-600);
        this.access2.style('background', 'white');  

        this.button2 = createButton('Check');
        this.button2.position(displayWidth-300,displayHeight-500);
        this.button2.style('background', 'lightgrey');

        this.access3 = createInput("Code1")
        this.access3.position(displayWidth-700,displayHeight-350);
